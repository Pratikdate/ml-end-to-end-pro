...
def error_message_detail(error,error_details):
    ...
    error_message="Error occurred while processing script name {{0}} line number {{1}} error message".format(file_name,exc_tb.tb_lineno,str(error))
